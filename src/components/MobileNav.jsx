...
const MobileNav = ({ openNav, setOpenNav }) => {
  ...
  return (
    <div
      className={`w-screen h-screen px-8 py-10 bg-dark-blue/95 flex flex-col fixed top-0 left-0 z-20 transition-transform duration-500 transfrom  ${openNav ? "translate-x-0" : "translate-x-full"}`}
    >
